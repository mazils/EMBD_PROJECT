...
# module references:
# bin2ascii, clk_divider, tx_helper, tx_mod
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set HD_GPIO_4 [ create_bd_port -dir O HD_GPIO_4 ]
  set RADIO_LED0 [ create_bd_port -dir O RADIO_LED0 ]
  ...
  # Create instance: bin2ascii_0, and set properties
  set block_name bin2ascii
  set block_cell_name bin2ascii_0
  if { [catch {set bin2ascii_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bin2ascii_0 eq "" } {
  ...
  set_property -dict [ list \
   CONFIG.C_M_AXI_AXI_DATA_DATA_WIDTH {128} \
 ] $nn_inference_0
  ...
  # Create instance: tx_helper_0, and set properties
  set block_name tx_helper
  set block_cell_name tx_helper_0
  if { [catch {set tx_helper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $tx_helper_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins nn_inference_0/s_axi_control]
  ...
  connect_bd_intf_net -intf_net nn_inference_0_m_axi_AXI_DATA [get_bd_intf_pins axi_smc/S01_AXI] [get_bd_intf_pins nn_inference_0/m_axi_AXI_DATA]
  ...
  connect_bd_net -net bin2ascii_0_char [get_bd_pins bin2ascii_0/char] [get_bd_pins tx_mod_0/data_in]
  connect_bd_net -net clk_divider_0_clk_div [get_bd_pins clk_divider_0/clk_div] [get_bd_pins tx_helper_0/slw_clk] [get_bd_pins tx_mod_0/clkfast]
  connect_bd_net -net delay_or_latch_0_int_out [get_bd_ports RADIO_LED0] [get_bd_pins tx_helper_0/shift_load] [get_bd_pins tx_mod_0/shift_load]
  connect_bd_net -net nn_inference_0_out_wire [get_bd_pins bin2ascii_0/bin] [get_bd_pins nn_inference_0/out_wire]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins clk_divider_0/rst] [get_bd_pins nn_inference_0/ap_rst_n] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins tx_helper_0/rst] [get_bd_pins tx_mod_0/rst]
  connect_bd_net -net tx_mod_0_sout [get_bd_ports HD_GPIO_4] [get_bd_pins tx_mod_0/sout]
  connect_bd_net -net tx_mod_0_xmitmt [get_bd_pins tx_helper_0/xmitmt] [get_bd_pins tx_mod_0/xmitmt]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins clk_divider_0/clk] [get_bd_pins nn_inference_0/ap_clk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces nn_inference_0/Data_m_axi_AXI_DATA] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs nn_inference_0/s_axi_control/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces nn_inference_0/Data_m_axi_AXI_DATA] [get_bd_addr_segs axi_intc_0/S_AXI/Reg]
  exclude_bd_addr_seg -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces nn_inference_0/Data_m_axi_AXI_DATA] [get_bd_addr_segs nn_inference_0/s_axi_control/Reg]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces nn_inference_0/Data_m_axi_AXI_DATA] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM]
